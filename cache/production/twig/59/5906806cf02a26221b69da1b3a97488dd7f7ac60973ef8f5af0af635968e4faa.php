...
/* login_body.html */
class __TwigTemplate_66dd63911d42097f7e2fabcf7a7b6a16b40f202fcaa67f881ac90ed855f3e39d extends Twig_Template
{
...
\t\t";
        ...
        if (( !($context["S_ADMIN_AUTH"] ?? null) && ($context["PROVIDER_TEMPLATE_FILE"] ?? null))) {
            ...
            $this->loadTemplate((("" . ($context["PROVIDER_TEMPLATE_FILE"] ?? null)) . ""), "login_body.html", 78)->display($context);
            if ($namespace) {
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }
            // line 79
