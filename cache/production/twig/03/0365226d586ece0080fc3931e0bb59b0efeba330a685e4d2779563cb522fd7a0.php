...
/* viewtopic_body.html */
class __TwigTemplate_e72f40b3efa744c95400f172aa91fe39a7b00fdb1211c84788a19c6cdbff1c13 extends Twig_Template
{
...
\t\t\t\t\t\t";
                // line 92
                if (($this->getAttribute($context["poll_option"], "POLL_OPTION_VOTED", array()) || ($context["S_DISPLAY_RESULTS"] ?? null))) {
...
\t\t\t\t\t\t\t\t\t\t";
                ...
                if ($this->getAttribute($context["postrow"], "S_ONLINE", array())) {
                    ...
                    echo $this->getAttribute(($context["definition"] ?? null), "ONLINE_BADGE", array());
...
\t\t\t\t\t\t\t\t\t\t";
                    ...
                    echo $this->getAttribute(($context["definition"] ?? null), "OFFLINE_BADGE", array());
                    echo "\"></i><span class=\"sr-only\">";
                    echo $this->env->getExtension('phpbb\template\twig\extension')->lang("ONLINE");
                    echo "</span>
\t\t\t\t\t\t\t\t\t\t";
...
\t\t<a href=\"";
        // line 441
        echo ($context["U_VIEW_OLDER_TOPIC"] ?? null);
...
\t\t<a href=\"";
        // line 467
        echo ($context["U_VIEW_NEWER_TOPIC"] ?? null);
...
\t\t\t<form method=\"post\" action=\"";
            // line 486
            echo ($context["S_MOD_ACTION"] ?? null);
            echo "\" class=\"form-inline pull-right\">
\t\t\t\t<fieldset class=\"quickmod\">
\t\t\t\t\t";
            // line 488
            echo ($context["S_TOPIC_MOD"] ?? null);
...
";
        // line 496
        if ((( !($context["S_USER_LOGGED_IN"] ?? null) &&  !($context["S_IS_BOT"] ?? null)) && ($this->getAttribute(($context["definition"] ?? null), "SHOW_LOGIN_PANEL", array()) == 1))) {
            // line 497
            echo "\t";
