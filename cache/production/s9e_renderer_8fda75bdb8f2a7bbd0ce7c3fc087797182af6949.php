...
*/
class s9e_renderer_8fda75bdb8f2a7bbd0ce7c3fc087797182af6949 extends \s9e\TextFormatter\Renderer
{
	...
	protected function quick($m)
	{
		...
		if($qb<7)if($qb<4)if($qb===0){$html='';if($this->params['STYLE_ID']==2)$html.='</strong>';else$html.='</span>';}elseif($qb===1){$html='';if($this->params['STYLE_ID']==2)$html.='</em>';else$html.='</span>';}elseif($qb===2){$attributes=array_pop(self::$attributes);$html='';if(!isset($attributes['type']))$html.='</ul>';elseif((strpos('upperlowerdecim',mb_substr(htmlspecialchars_decode($attributes['type']),0,5,'utf-8'))!==false))$html.='</ol>';else$html.='</ul>';}else{$attributes+=array('index'=>null,'filename'=>null);$html='<div class="inline-attachment"><!-- ia'.str_replace('&quot;','"',$attributes['index']).' -->'.str_replace('&quot;','"',$attributes['filename']).'<!-- ia'.str_replace('&quot;','"',$attributes['index']).' --></div>';}elseif($qb===4){$html='';if($this->params['STYLE_ID']==2)$html.='<strong>';else$html.='<span style="font-weight: bold">';}elseif($qb===5)$html='<div class="codebox"><p>'.htmlspecialchars($this->params['L_CODE'].$this->params['L_COLON'],0).' <a href="#" onclick="selectCode(this); return false;">'.htmlspecialchars($this->params['L_SELECT_ALL_CODE'],0).'</a></p><pre><code>';else{$html='';if(empty($this->params['S_VIEWSMILIES']))$html.=htmlspecialchars($textContent,0);elseif(isset(self::$btA66C2C3F[$textContent])){$n=self::$btA66C2C3F[$textContent];$html.='<img class="smilies" src="'.htmlspecialchars($this->params['T_SMILIES_PATH'],2);if($n<21)if($n<11)if($n<6)if($n<3)if($n===0)$html.='/icon_cool.gif" width="15" height="17" alt="8-)" title="Fetzig">';elseif($n===1)$html.='/icon_exclaim.gif" width="15" height="17" alt=":!:" title="Ausruf">';else$html.='/icon_e_sad.gif" width="15" height="17" alt=":(" title="Traurig">';elseif($n===3)$html.='/icon_e_smile.gif" width="15" height="17" alt=":)" title="Lächeln">';elseif($n===4)$html.='/icon_e_sad.gif" width="15" height="17" alt=":-(" title="Traurig">';else$html.='/icon_e_smile.gif" width="15" height="17" alt=":-)" title="Lächeln">';elseif($n<9)if($n===6)$html.='/icon_e_confused.gif" width="15" height="17" alt=":-?" title="Verwirrt">';elseif($n===7)$html.='/icon_e_biggrin.gif" width="15" height="17" alt=":-D" title="Überglücklich">';else$html.='/icon_razz.gif" width="15" height="17" alt=":-P" title="Hänseln">';elseif($n===9)$html.='/icon_e_surprised.gif" width="15" height="17" alt=":-o" title="Überrascht">';else$html.='/icon_mad.gif" width="15" height="17" alt=":-x" title="Verärgert">';elseif($n<16)if($n<14)if($n===11)$html.='/icon_neutral.gif" width="15" height="17" alt=":-|" title="Neutral">';elseif($n===12)$html.='/icon_e_confused.gif" width="15" height="17" alt=":?" title="Verwirrt">';else$html.='/icon_question.gif" width="15" height="17" alt=":?:" title="Frage">';elseif($n===14)$html.='/icon_e_confused.gif" width="15" height="17" alt=":???:" title="Verwirrt">';else$html.='/icon_e_biggrin.gif" width="15" height="17" alt=":D" title="Überglücklich">';elseif($n<19)if($n===16)$html.='/icon_razz.gif" width="15" height="17" alt=":P" title="Hänseln">';elseif($n===17)$html.='/icon_arrow.gif" width="15" height="17" alt=":arrow:" title="Pfeil">';else$html.='/icon_cool.gif" width="15" height="17" alt=":cool:" title="Fetzig">';elseif($n===19)$html.='/icon_cry.gif" width="15" height="17" alt=":cry:" title="Weinend oder sehr traurig">';else$html.='/icon_e_surprised.gif" width="15" height="17" alt=":eek:" title="Überrascht">';elseif($n<32)if($n<27)if($n<24)if($n===21)$html.='/icon_evil.gif" width="15" height="17" alt=":evil:" title="Böse oder sehr verärgert">';elseif($n===22)$html.='/icon_e_geek.gif" width="17" height="17" alt=":geek:" title="Computerfreak">';else$html.='/icon_e_biggrin.gif" width="15" height="17" alt=":grin:" title="Überglücklich">';elseif($n===24)$html.='/icon_idea.gif" width="15" height="17" alt=":idea:" title="Idee">';elseif($n===25)$html.='/icon_lol.gif" width="15" height="17" alt=":lol:" title="Lachend">';else$html.='/icon_mad.gif" width="15" height="17" alt=":mad:" title="Verärgert">';elseif($n<30)if($n===27)$html.='/icon_mrgreen.gif" width="15" height="17" alt=":mrgreen:" title="Mr. Green">';elseif($n===28)$html.='/icon_e_surprised.gif" width="15" height="17" alt=":o" title="Überrascht">';else$html.='/icon_redface.gif" width="15" height="17" alt=":oops:" title="Verlegen">';elseif($n===30)$html.='/icon_razz.gif" width="15" height="17" alt=":razz:" title="Hänseln">';else$html.='/icon_rolleyes.gif" width="15" height="17" alt=":roll:" title="Augen verdrehen">';elseif($n<37)if($n<35)if($n===32)$html.='/icon_e_sad.gif" width="15" height="17" alt=":sad:" title="Traurig">';elseif($n===33)$html.='/icon_eek.gif" width="15" height="17" alt=":shock:" title="Erschüttert">';else$html.='/icon_e_smile.gif" width="15" height="17" alt=":smile:" title="Lächeln">';elseif($n===35)$html.='/icon_twisted.gif" width="15" height="17" alt=":twisted:" title="Verrückter Teufel">';else$html.='/icon_e_ugeek.gif" width="17" height="18" alt=":ugeek:" title="Extremer Computerfreak">';elseif($n<40)if($n===37)$html.='/icon_e_wink.gif" width="15" height="17" alt=":wink:" title="Zwinkern">';elseif($n===38)$html.='/icon_mad.gif" width="15" height="17" alt=":x" title="Verärgert">';else$html.='/icon_neutral.gif" width="15" height="17" alt=":|" title="Neutral">';elseif($n===40)$html.='/icon_e_wink.gif" width="15" height="17" alt=";)" title="Zwinkern">';else$html.='/icon_e_wink.gif" width="15" height="17" alt=";-)" title="Zwinkern">';}else$html.=htmlspecialchars($textContent,0);}elseif($qb<10)if($qb===7){$attributes+=array('email'=>null,'body'=>null);$html='<a href="mailto:'.$attributes['email'];if(isset($attributes['subject'])||isset($attributes['body'])){$html.='?';if(isset($attributes['subject']))$html.='subject='.$attributes['subject'];if(isset($attributes['body'])){if(isset($attributes['subject']))$html.='&amp;';$html.='body='.$attributes['body'];}}$html.='">';}elseif($qb===8){$attributes+=array('seq'=>null);$html='';if(!empty($this->params['S_VIEWSMILIES']))$html.='<img alt="'.htmlspecialchars($textContent,2).'" class="emoji smilies" draggable="false" src="//cdn.jsdelivr.net/emojione/assets/svg/'.$attributes['seq'].'.svg">';else$html.=htmlspecialchars($textContent,0);}else{$html='';if($this->params['STYLE_ID']==2)$html.='<em>';else$html.='<span style="font-style: italic">';}elseif($qb===10){$attributes+=array('text'=>null);$html=str_replace('&quot;','"',$attributes['text']);}elseif($qb===11){$attributes+=array('type'=>null);$html='';if(!isset($attributes['type']))$html.='<ul>';elseif((strpos('upperlowerdecim',mb_substr(htmlspecialchars_decode($attributes['type']),0,5,'utf-8'))!==false))$html.='<ol style="list-style-type: '.$attributes['type'].'">';else$html.='<ul style="list-style-type: '.$attributes['type'].'">';self::$attributes[]=$attributes;}else{$attributes+=array('url'=>null,'author'=>null,'post_id'=>null);$html='<blockquote';if(!isset($attributes['author']))$html.=' class="uncited"';$html.='><div>';if(isset($attributes['author'])){$html.='<cite>';if(isset($attributes['url']))$html.='<a href="'.$attributes['url'].'" class="postlink">'.str_replace('&quot;','"',$attributes['author']).'</a>';elseif(isset($attributes['profile_url']))$html.='<a href="'.$attributes['profile_url'].'">'.str_replace('&quot;','"',$attributes['author']).'</a>';else$html.=str_replace('&quot;','"',$attributes['author']);$html.=' '.htmlspecialchars($this->params['L_WROTE'].$this->params['L_COLON'],0);if(isset($attributes['post_url']))$html.=' <a href="'.$attributes['post_url'].'" data-post-id="'.$attributes['post_id'].'" onclick="if(document.getElementById(hash.substr(1)))href=hash">↑</a>';if(isset($attributes['date']))$html.='<div class="responsive-hide">'.str_replace('&quot;','"',$attributes['date']).'</div>';$html.='</cite>';}}
