...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000028441cb200007f850398cab6(
...
class phpbbtemplatetwiglexer_0000000028441cb200007f850398cab6 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a20bb38c4885025810991 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a20bb38c489f129372475 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a20bb38c4848794732400 = array(
    ...
    {
        $this->initializer5a20bb38c489f129372475 && $this->initializer5a20bb38c489f129372475->__invoke($this->valueHolder5a20bb38c4885025810991, $this, 'set_environment', array('env' => $env), $this->initializer5a20bb38c489f129372475);

        return $this->valueHolder5a20bb38c4885025810991->set_environment($env);
    }
    ...
    {
        $this->initializer5a20bb38c489f129372475 && $this->initializer5a20bb38c489f129372475->__invoke($this->valueHolder5a20bb38c4885025810991, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a20bb38c489f129372475);

        return $this->valueHolder5a20bb38c4885025810991->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a20bb38c489f129372475 && $this->initializer5a20bb38c489f129372475->__invoke($this->valueHolder5a20bb38c4885025810991, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a20bb38c489f129372475);

        return $this->valueHolder5a20bb38c4885025810991->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a20bb38c489f129372475 = $initializer;
    }
    ...
    {
        $this->initializer5a20bb38c489f129372475 && $this->initializer5a20bb38c489f129372475->__invoke($this->valueHolder5a20bb38c4885025810991, $this, '__get', array('name' => $name), $this->initializer5a20bb38c489f129372475);

        if (isset(self::$publicProperties5a20bb38c4848794732400[$name])) {
            return $this->valueHolder5a20bb38c4885025810991->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a20bb38c4885025810991;
    ...
    {
        $this->initializer5a20bb38c489f129372475 && $this->initializer5a20bb38c489f129372475->__invoke($this->valueHolder5a20bb38c4885025810991, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a20bb38c489f129372475);
    ...
    {
        $this->initializer5a20bb38c489f129372475 && $this->initializer5a20bb38c489f129372475->__invoke($this->valueHolder5a20bb38c4885025810991, $this, '__isset', array('name' => $name), $this->initializer5a20bb38c489f129372475);
    ...
    {
        $this->initializer5a20bb38c489f129372475 && $this->initializer5a20bb38c489f129372475->__invoke($this->valueHolder5a20bb38c4885025810991, $this, '__unset', array('name' => $name), $this->initializer5a20bb38c489f129372475);
    ...
    {
        $this->initializer5a20bb38c489f129372475 && $this->initializer5a20bb38c489f129372475->__invoke($this->valueHolder5a20bb38c4885025810991, $this, '__clone', array(), $this->initializer5a20bb38c489f129372475);

        $this->valueHolder5a20bb38c4885025810991 = clone $this->valueHolder5a20bb38c4885025810991;
    }

    public function __sleep()
    {
        $this->initializer5a20bb38c489f129372475 && $this->initializer5a20bb38c489f129372475->__invoke($this->valueHolder5a20bb38c4885025810991, $this, '__sleep', array(), $this->initializer5a20bb38c489f129372475);

        return array('valueHolder5a20bb38c4885025810991');
    }
    ...
    {
        return $this->initializer5a20bb38c489f129372475;
    }
    ...
    {
        return $this->initializer5a20bb38c489f129372475 && $this->initializer5a20bb38c489f129372475->__invoke($this->valueHolder5a20bb38c4885025810991, $this, 'initializeProxy', array(), $this->initializer5a20bb38c489f129372475);
    }
    ...
    {
        return null !== $this->valueHolder5a20bb38c4885025810991;
    }
    ...
    {
        return $this->valueHolder5a20bb38c4885025810991;
    }
